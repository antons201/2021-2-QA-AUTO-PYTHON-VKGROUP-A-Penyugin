...
class DashboardPageLocators(AuthPageLocators):
    ...
    CREATE_COMPANY_LOCATOR = (By.XPATH, "//div[contains(@class, 'button-module-textWrapper') and contains(string(), 'Создать кампанию')]")
    ...
    SUBMIT_CREATE_LOCATOR = (By.XPATH, "//div[contains(@class, 'button__text') and contains(string(), 'Создать кампанию')]")
